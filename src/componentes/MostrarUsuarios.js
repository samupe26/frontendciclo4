        ...
        <div className='container'>
            <div className='row'>
                <div className='col'>
                    ...
                    <Link to='/usuarios/agregar/' className='btn btn-primary mt-2 mb-2'><i className="fa-solid fa-user-plus"></i> </Link>
                    <table className='table'>
                        ...
                        <tbody>
                            ...
                            <tr key = { index }>
                               ...
                               <td>
                                <Link to={`/usuarios/editar/${usuario._id}`} className='btn btn-primary'><i className="fa-solid fa-pen"></i></Link>
